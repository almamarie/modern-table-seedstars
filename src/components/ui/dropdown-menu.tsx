...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex items-center gap-2 data-[state=open]:bg-accent focus:bg-accent px-2 py-1.5 rounded-sm outline-none [&_svg]:size-4 text-sm cursor-default [&_svg]:pointer-events-none select-none [&_svg]:shrink-0",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 bg-blue-900 bg-popover shadow-md p-1 border rounded-md min-w-[8rem] overflow-hidden text-popover-foreground",
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex items-center focus:bg-accent data-[disabled]:opacity-50 py-1.5 pr-2 pl-8 rounded-sm outline-none text-sm transition-colors focus:text-accent-foreground cursor-default data-[disabled]:pointer-events-none select-none",
      className
    )}
    checked={checked}
    {...props}
